    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12 social-networks">
                <a href="http://twitter.com/hackerpair" class="twitter">
                    <i class="fa-brands fa-twitter"></i>
                </a>
                <a href="http://facebook.com/hackerpair" class="facebook">
                    <i class="fa-brands fa-facebook-f"></i>
                </a>
                <a href="http://github.com/wjgilmore/hackerpair" class="github">
